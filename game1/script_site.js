...
let start = function(){
	...
	setTimeout(() => {
		...
		document.body.innerHTML = `<br><div><h1>history:</h1></div><div class="history">${usr}</div><div><a href="https://erri4.github.io/site1/game1/site.html" target="_self"><button>play again</button></a></div>`;
}, Number(`${time}000`))
}
